      ...
      <div class="container px-6 py-12 mx-auto">
          ...
          <div class="grid grid-cols-1 gap-12 mt-10 md:grid-cols-2 lg:grid-cols-3">
              <div>
                  ...
                  <p class="mt-2 text-blue-500 dark:text-blue-400">mksinghbist@gmail.com</p>
              </div>
              ...
              <div>
                  ...
                  <p class="mt-2 text-blue-500 dark:text-blue-400">Noida sector 102, Bharat</p>
              </div>
              ...
              <div>
                  ...
                  <p class="mt-2 text-gray-500 dark:text-gray-400">Mon-Fri from 10 am to 6pm.</p>
                  <p class="mt-2 text-blue-500 dark:text-blue-400">+918871208846</p>
              </div>
          </div>
      </div>
  </section>
